...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[FRONTEND_URL, 'http://localhost:3001', 'http://127.0.0.1:3001', 'http://10.12.25.237:3000', 'https://cold-begging.vercel.app', 'https://cold-begging-c4rm2olv2-gk022135s-projects.vercel.app'],
    allow_methods=['*'],
    allow_headers=['*'],
